...
aligned_loci_path=$DATA/$DATASET/simulated_loci_filtered
# path to output folder (will be created if doesn't exits):
OUTPUT=$PROJECT/output/$DATASET/iqtree_assessment/CatTree_Filtered
...
${iqtree_exe} -nt 24 -s concatenated_loci.fasta -spp partitions.txt -pre filtered_loci -m MFP -bb 1000 -alrt 1000
